...
public class FriendManagement2 extends JFrame{
	Connection con = null;
	...
	public FriendManagement2() {
		...
		jbt2.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				String F_id = jtf1.getText();
				String F_name = jtf2.getText();
				String F_gender = jcb1.getSelectedItem().toString();
				if (F_gender=="선택") {
					F_gender="";
				}
				String F_phone = jtf3.getText();
				...
				if(F_enamilEnd=="선택") {
					...
					F_email = F_enamilFront+"@"+F_enamilEnd;
				}
				String F_photo = imageloot;
				dao.insert(F_id,F_name,F_gender,F_phone,F_email,F_photo);
		...
		jbt3.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String F_photo = imageloot;
				dao.update(F_id,F_name,F_gender,F_phone,F_email,F_photo);
				jtf1.setText(""); jtf2.setText(""); jcb1.setSelectedItem("선택");
				jtf3.setText(""); jtf4.setText(""); jcb2.setSelectedItem("선택");
				jtf1.requestFocus();
				model.setRowCount(0);
	...
	void select() {
			ArrayList<FriendsVO> list = dao.select();
			Iterator<FriendsVO> it = list.iterator();
			while(it.hasNext()) {
				FriendsVO vo = it.next();
				String F_id = vo.getF_id();
				String F_name = vo.getF_name();
				String F_gender = vo.getF_gender();
				String F_phone = vo.getF_phone();
				String F_email = vo.getF_email();
				String F_Edate = vo.getF_edate();
