...
public class JoinScreen extends JFrame {
	...
	JRadioButton client, manager, etc;
	...
	public JoinScreen() {
		...
		radioPanel.add(manager); radioPanel.add(etc);
		...
		client.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				JOptionPane.showMessageDialog(null, client.getText()+"을 선택하셨군요");
		...
		manager.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				JOptionPane.showMessageDialog(null, manager.getText()+"을 선택하셨군요");
		...
		etc.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				JOptionPane.showMessageDialog(null, etc.getText()+"을 선택하셨군요");
